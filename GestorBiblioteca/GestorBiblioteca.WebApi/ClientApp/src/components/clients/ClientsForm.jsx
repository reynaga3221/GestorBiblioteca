...
const ClientsForm = ({ classes, Client, setClient, handleAddClient, handleCleanClient }) => {
    ...
    return (
        <>
            ...
            <Grid item xs={6}>   
                <TextField value={Client.mail ? Client.mail : ''} label="Mail" variant="outlined" size="small" onChange={(e) => setClient({ ...Client, mail: e.target.value })} style={{ marginTop: 20, marginRight: 20 }} />
            </Grid>
